...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXCheckBox AlignLeft="True" runat="server" ID="CstPXCheckBox2" DataField="RequireReferenceShipmentID" ></px:PXCheckBox>
                        ...
                        <px:PXNumberEdit runat="server" ID="CstPXNumberEdit3" DataField="DefPalletHeight"></px:PXNumberEdit></px:PXPanel>
                </Template>
            </px:PXTabItem>
        </Items>
