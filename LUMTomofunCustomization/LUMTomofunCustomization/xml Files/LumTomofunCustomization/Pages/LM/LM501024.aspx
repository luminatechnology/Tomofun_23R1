<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" CodeFile="LM501024.aspx.cs" Inherits="Pages_LM501024" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
        TypeName="LumTomofunCustomization.Graph.LUMAmazonPaymentProcess"
        ...
        <Levels>
            <px:PXGridLevel DataMember="PaymentTransactions">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="TransactionPostedDate"></px:PXGridColumn>
                    <px:PXGridColumn DataField="TransactionType"></px:PXGridColumn>
                    <px:PXGridColumn DataField="AmazonTransactionId"></px:PXGridColumn>
                    <px:PXGridColumn DataField="AmazonOrderReferenceId" />
                    <px:PXGridColumn DataField="SellerOrderId" />
                    <px:PXGridColumn DataField="OrderID" />
                    <px:PXGridColumn DataField="TransactionAmount" />
                    <px:PXGridColumn DataField="TotalTransactionFee" />
                    <px:PXGridColumn DataField="NetTransactionAmount" />
                    <px:PXGridColumn DataField="SettlementId" />
                    <px:PXGridColumn DataField="CurrencyCode" />
