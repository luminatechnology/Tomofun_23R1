<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" CodeFile="LM501026.aspx.cs" Inherits="Pages_LM501026" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
        TypeName="LumTomofunCustomization.Graph.LUMJPaypalJP_NPPaymentProcess"
        ...
        <Levels>
            <px:PXGridLevel DataMember="PaymentTransactions">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="Tax" />
                    <px:PXGridColumn DataField="Description" />
                    <px:PXGridColumn DataField="Buyer" />
