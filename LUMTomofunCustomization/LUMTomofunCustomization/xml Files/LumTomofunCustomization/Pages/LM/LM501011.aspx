<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="LM501011.aspx.cs" Inherits="Pages_LM501011" Title="Untitled Page" %>
        ...
        <Levels>
            <px:PXGridLevel DataMember="ShopifySourceData">
                <Columns>
                    ...
                    <%--<px:PXGridColumn DataField="JsonSource" Width="130"></px:PXGridColumn>--%>
