<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="LM501010.aspx.cs" Inherits="Pages_LM501010" Title="Untitled Page" %>
        ...
        <Levels>
            <px:PXGridLevel DataMember="AmazonSourceData">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="SequenceNumber" Width="120"></px:PXGridColumn>
